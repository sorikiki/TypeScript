...
exports.getPosts = function () { return __awaiter(void 0, void 0, void 0, function () {
...
exports.getPostById = function (id) { return __awaiter(void 0, void 0, void 0, function () {
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4 /*yield*/, delay(500)];
            case 1:
                _a.sent();
                return [2 /*return*/, posts.find(function (post) { return post.id === id; })];
        }
    });
}); };
